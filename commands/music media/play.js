...
//        // text: `🎵 *Song Command*\n\nUsage:\n• .song <song name>\n• .song <YouTube URL>\n• Reply to a message with .song\n\nExample:\n• .song Blinding Lights\n• .song https://youtube.com/watch?v=xxx` 
//        text: `🎵 *Play Downloader*\n\n` +
//       `💡 *Usage:*\n` +
//       `• \`${PREFIX}play your song name\`\n` +
//       `• \`${PREFIX}play YouTube URL\`\n` +
//       `📌 *Examples:*\n` +
//       `• \`${PREFIX}play Home by NF\`\n` +
//       `• \`${PREFIX}play https://youtube.com/watch?v=xxx\`\n` +
//       ``,
//       }, { quoted: m });
//       return;
//     }
...
//         console.log(`🎵 [SONG] Found: "${videoTitle}"`);
//       }
...
//         try {
//           const thumbnailResponse = await axios.get(result.result.thumbnail || thumbnail, {
...
//         await sock.sendMessage(jid, { 
//           text: `✅ *Song Sent!*\n\n"${result.result.title || videoTitle}"\n📦 Size: ${fileSizeMB}MB\n🎵 Audio Message Sent`,
//           edit: statusMsg.key 
//         });

//         console.log(`✅ [SONG] Success: "${result.result.title || videoTitle}"`);
